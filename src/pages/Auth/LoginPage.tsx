        ...
        <div style={{
            ...
            <div style={{
                ...
                <div style={{
                    position: 'absolute',
                    inset: 0,
                    background: 'linear-gradient(to top, #0e121b, rgba(14, 18, 27, 0.6), rgba(36, 99, 235, 0.1))',
                ...
                <div style={{
                    ...
                    <p style={{
                        ...
                        Access the world's most comprehensive catalog of electronic components for your next breakthrough.
                    </p>
                </div>
            </div>
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <div style={{ display: 'flex', gap: '12px' }}>
                        ...
                        >
                            <svg aria-hidden="true" style={{ width: '18px', height: '18px' }} viewBox="0 0 24 24">
                    ...
                    <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                            ...
                            <input
                                type="email"
                                id="email"
                                placeholder="maker@stemgear.com"
                    ...
                    <div style={{ textAlign: 'center', marginTop: '4px' }}>
                        <p style={{ color: '#4d6599', fontSize: '13px' }}>
                            New to STEM Gear?{' '}
